...
public class OpponentHealth : MonoBehaviour
{
    ...
    {
        if (GameManager.opponentObj[0].GetComponent<Base>().godsDestroyed == 0)
        {
            heart1.GetComponent<Image>().sprite = heart;
            heart2.GetComponent<Image>().sprite = heart;
            heart3.GetComponent<Image>().sprite = heart;
        }
        else if (GameManager.opponentObj[0].GetComponent<Base>().godsDestroyed == 1)
            heart3.GetComponent<Image>().sprite = empty;
        else if (GameManager.opponentObj[0].GetComponent<Base>().godsDestroyed == 2)
            heart2.GetComponent<Image>().sprite = empty;
        else if (GameManager.opponentObj[0].GetComponent<Base>().godsDestroyed == 3)
